                            ...
                            <table class="table">
                                ...
                                @foreach ($accounts as $account)
                                    @php
                                        ...
                                        $totalDebit   = 0;
                                        $totalCredit  = 0;
                                        $totalBalance =App\Models\Utility::getAccountBalance($account->id);
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="Action">
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('chart-of-account.show',$account->id) }}?account={{$account->id}}" class="mx-3 btn btn-sm align-items-center " data-bs-toggle="tooltip" title="{{__('Transaction Summary')}}" data-original-title="{{__('Detail')}}">
